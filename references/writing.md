...
4. Walk the session context. Extract content into the seven sections. Apply style rules: prose, specific, honest about empty sections.
...
7. Report to the user: path written, chain link if any, one-line summary of what was captured.
